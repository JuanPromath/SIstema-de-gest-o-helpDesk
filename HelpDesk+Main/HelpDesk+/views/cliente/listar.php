...
<div class="dashboard-header fade-in">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <a href="?controller=ClienteController&action=criar" class="btn-modern btn-modern-primary">
            ...
            <div class="card-modern h-100">
                <div class="card-body">
                    ...
                    <div class="mt-3 d-grid gap-2">
                        <a href="?controller=ClienteController&action=editar&id=' . $cliente->codigo . '" class="btn-modern btn-modern-secondary btn-sm">
                            <i class="bi bi-pencil"></i> Editar
                        </a>
                        <a href="?controller=ClienteController&action=excluir&id=' . $cliente->codigo . '" class="btn-modern btn-modern-outline btn-sm" style="color: #e74c3c; border-color: #e74c3c;" onclick="return confirm(\'Tem certeza que deseja excluir este cliente?\');">
    ...
    <div class="col-12 fade-in">
        <div class="card-modern">
            <div class="card-body text-center py-5">
                ...
                <a href="?controller=ClienteController&action=criar" class="btn-modern btn-modern-primary mt-3">
